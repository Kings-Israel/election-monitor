...
export default {
    ...
    created() {
        this.loading = true;
        axios.get('http://172.104.245.14/electionmonitor/api/v1/fetch-answers/question/"+this.$route.params.id')
        // axios.get("../api/v1/question/" + this.$route.params.id + "/answers")
            .then((response) => {
